...
import static acquisti.com.ouccelo.aquistiv2.R.id.imagebutton2;

public class ArticlesActivity extends ListActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
...
// See https://g.co/AppIndexing/AndroidStudio for more information.
        ...
        // datasource.getAllArticles(0, "", "", false, idliste, false);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Articles Page") // TODO: Define a title for the content shown.
